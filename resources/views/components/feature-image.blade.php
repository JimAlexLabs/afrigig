...
@if($imageUrl)
    <div {{ $attributes->merge(['class' => 'relative overflow-hidden rounded-lg shadow-lg ' . $class]) }}>
        ...
        >
        <div class="hidden p-4 bg-red-50 dark:bg-red-900 text-red-600 dark:text-red-200 rounded-lg">
...
@else
    @if(config('app.debug'))
        <div class="bg-yellow-100 dark:bg-yellow-900 border-l-4 border-yellow-500 text-yellow-700 dark:text-yellow-200 p-4 mb-4">
