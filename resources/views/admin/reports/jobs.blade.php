        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Total Jobs</h3>
                        <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">{{ number_format($stats['total_jobs']) }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Bidding Stats</h3>
                        <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">{{ number_format($stats['total_bids']) }}</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Average Job Value</h3>
                        <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">${{ number_format($stats['avg_job_value'], 2) }}</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
