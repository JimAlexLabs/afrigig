    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Configuration Status</h3>
                    <div class="space-y-2">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Test Results</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach($tests as $type => $image)
                            <div class="space-y-4">
                                <h4 class="font-medium text-gray-700 dark:text-gray-300 capitalize">{{ str_replace('_', ' ', $type) }}</h4>
                                @if($image)
                                    <x-feature-image 
                                ...
                                @else
                                    <div class="bg-yellow-50 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-200 p-4 rounded">
                                        No image found
                                    </div>
                                @endif
                            </div>
