<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('jobs.public')" :active="request()->routeIs('jobs.public')">
                        {{ __('Browse Jobs') }}
                    </x-nav-link>
                    ...
                    @auth
                        ...
                        @if(auth()->user()->isFreelancer())
                            <x-nav-link :href="route('bids.my')" :active="request()->routeIs('bids.my')">
                                {{ __('My Bids') }}
                            </x-nav-link>
                        @endif
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    ...
                    <div class="mr-4">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-900">${{ number_format(auth()->user()->balance, 2) }}</span>
                    </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('jobs.public')" :active="request()->routeIs('jobs.public')">
                {{ __('Browse Jobs') }}
            </x-responsive-nav-link>
