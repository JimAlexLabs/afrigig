    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">User Types</h3>
                        <div class="space-y-2">
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-500">Clients</span>
                                <span class="text-sm font-medium text-gray-900">{{ number_format($stats['clients']) }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-500">Freelancers</span>
                                <span class="text-sm font-medium text-gray-900">{{ number_format($stats['freelancers']) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-3xl font-bold text-gray-900">{{ number_format($stats['recent_signups']) }}</p>
                        <p class="text-sm text-gray-500 mt-1">New users in the last 30 days</p>
                    </div>
                </div>
            </div>
