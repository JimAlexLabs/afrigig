                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        <form method="GET" action="{{ route('admin.jobs') }}" class="flex gap-4">
                            ...
                            <select name="status" class="rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($jobs as $job)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900">${{ number_format($job->budget, 2) }}</div>
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900">{{ $job->bids->count() }}</div>
                                        </td>
                                        <td class="px-6 py-4 text-sm font-medium">
                                            <div class="flex space-x-3">
                                                <a href="{{ route('admin.jobs.show', $job) }}" class="text-blue-600 hover:text-blue-900">
                                                    View Details
                                                </a>
