                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-8 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <p class="text-sm text-gray-600">Skill</p>
                    ...
                    <form action="{{ route('admin.skill-assessments.feedback.store', $attempt) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label for="feedback" class="block text-sm font-medium text-gray-700">Detailed Feedback</label>
                        ...
                        <div class="space-y-4">
                            <label class="block text-sm font-medium text-gray-700">Recommended Resources</label>
